...
public class Example : MonoBehaviour {
	...
	void Update () 
	{
		...
		DebugExtension.DebugCone(new Vector3(50, 0, 0), debugCone_Direction, debugCone_Color, debugCone_Angle, length: 1);
		DebugExtension.DebugArrow(new Vector3(60, 0, 0), debugArrow_Direction, 1f, debugArrow_Color);
