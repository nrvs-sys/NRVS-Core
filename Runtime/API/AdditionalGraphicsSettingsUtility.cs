...
/// <summary>
/// Enables getting/setting URP graphics properties that don't have built-in getters and setters.
/// </summary>
public static class AdditionalGraphicsSettingsUtility
{
    ...
    static AdditionalGraphicsSettingsUtility()
    {
