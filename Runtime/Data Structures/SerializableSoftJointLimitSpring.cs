...
using UnityEngine;
    ...
    public class SerializableSoftJointLimitSpring
    {
        ...
        public static implicit operator SoftJointLimitSpring(SerializableSoftJointLimitSpring c)
        {
            return new SoftJointLimitSpring() { spring = c._spring, damper = c._damper };
        }
        public static explicit operator SerializableSoftJointLimitSpring(SoftJointLimitSpring c)
        {
            return new SerializableSoftJointLimitSpring(c);
        }

        public SerializableSoftJointLimitSpring() { }
        private SerializableSoftJointLimitSpring(SoftJointLimitSpring _data)
        {
